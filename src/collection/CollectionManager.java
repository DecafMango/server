...
public final class CollectionManager {
    ...
    private volatile static ArrayList<Dragon> collection;
    ...
    public synchronized static void addElement(Dragon dragon) {
        collection.add(dragon);
        collection.sort(new DragonComparator());
        save();
        System.out.println("Добавлен объект. Кол-во объектов: " + collection.size() + ".");
    }
    public synchronized static void removeElement(Dragon dragon) {
        Stream stream = collection.stream();
    ...
    public synchronized static void removeElementByindex(int index) {
